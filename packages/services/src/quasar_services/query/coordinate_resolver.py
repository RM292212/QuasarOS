...
# Standard depth levels (31 levels in meters, positive downward)
DEPTH_LUT_METERS: List[float] = [
...
# Spatial bounds and resolution for Copernicus PHY Thetao
MIN_LATITUDE: float = -3.0
MAX_LATITUDE: float = 12.0
MIN_LONGITUDE: float = 80.0
MAX_LONGITUDE: float = 88.0
LAT_POINTS: int = 181
LON_POINTS: int = 97
